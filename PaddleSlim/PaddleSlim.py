...
place = exe.place
quant_program = slim.quant.quant_aware(train_program, place, for_test=False)       #请在次数添加你的代码
val_quant_program = slim.quant.quant_aware(val_program, place, for_test=True)  #关闭策略    #请在次数添加你的代码

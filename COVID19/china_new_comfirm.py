...
# 读原始数据文件
datafile = '/Users/liuhui/Desktop/COVID19/data/statistics_data.json'
...
line.add_yaxis("其他省份新增病例", other_statis, is_smooth=True,
               ...
               itemstyle_opts=opts.ItemStyleOpts(color='#F1A846',
                                                 border_color="#F1A846",
                                                 border_width=3))
line.set_global_opts(title_opts=opts.TitleOpts(title="新增确诊病例" + today, subtitle='数据来源：丁香园'),
...
line.render(path='/Users/liuhui/Desktop/COVID19/html/新增确诊趋势图' + today + '.html')
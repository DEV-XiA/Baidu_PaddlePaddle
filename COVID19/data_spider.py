...
def crawl_dxy_data():
    ...
    try:
        ...
        with open('/Users/liuhui/Desktop/COVID19/data/' + today + '.json', 'w', encoding='UTF-8') as f:
...
def crawl_statistics_data():
    ...
    with open("/Users/liuhui/Desktop/COVID19/data/statistics_data.json", "w", encoding='UTF-8') as f:
